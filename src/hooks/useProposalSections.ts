...
export function useProposalSections(templateTypeId: string | null, proposalId?: string | null, proposalLoaded?: boolean, isCoordinator?: boolean) {
  ...
  const allSections = useMemo(() => {
    // Topic information section (above Part A)
    const topicInfoSection: Section = {
      id: 'topic-info',
      number: '',
  ...
  }, [templateSections, hasTemplateSections, wpDraftSections, caseDraftSections, casesEnabled, caseTypeFlags, isCoordinator]);
