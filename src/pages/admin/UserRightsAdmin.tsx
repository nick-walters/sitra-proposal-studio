          ...
          <CardContent>
            {loading ? (
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                     <TableHead className="font-bold w-[220px]">User</TableHead>
                     <TableHead className="font-bold w-[220px]">Email</TableHead>
                            ...
                            <div>
                              ...
                              {isAdminOrOwner && (
                                <Button
                                  variant="ghost"
                                  size="sm"
                                  className="h-6 px-1.5 text-xs text-muted-foreground hover:text-foreground mt-1"
