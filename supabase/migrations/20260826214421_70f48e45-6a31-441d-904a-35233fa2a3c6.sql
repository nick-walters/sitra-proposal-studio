...
BEGIN
  ...
  IF NOT p_confirm_overwrite THEN
    RAISE EXCEPTION 'migrate_b12_to_cards requires explicit overwrite confirmation';
  END IF;
...
REVOKE ALL ON FUNCTION public.migrate_b12_to_cards(uuid, boolean) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.migrate_b12_to_cards(uuid, boolean) TO authenticated, service_role;