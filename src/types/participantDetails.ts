...
export const ORGANISATION_ROLES = [
  { value: 'project_management', label: 'Project management', description: 'Your organisation will do project management activities (i.e. assigning the tasks, reporting and interface with the EC). These tasks are normally carried out by the coordinator, but other participants can also contribute.' },
  { value: 'communication', label: 'Communication, dissemination and engagement', description: 'Your organisation will be in charge of communication, dissemination and engagement. This can be centralised by one partner or split across the partners.' },
  { value: 'infrastructure', label: 'Provision of research and technology infrastructure', description: 'Your organisation is providing a research facility or research equipment.' },
  { value: 'market_needs', label: 'Co-definition of research and market needs', description: 'Your organisation will be involved in co-defining the research and market needs. Usually it is a company that intends to later use the research results, or a NGO that will use the solution. This will help the project further tailor its results to respond to specific needs of the end user.' },
  { value: 'civil_society', label: 'Civil society representative', description: 'Your organisation belongs to civil society (NGO, association, organisation, consumer group, community group, charity, etc.).' },
  { value: 'policy_maker', label: 'Policy maker or regulator, incl. standardisation body', description: 'Your organisation is a policy maker (local, regional, national, European level), regulator or a standardisation body.' },
  { value: 'research_performer', label: 'Research performer', description: 'Your organisation is in charge of performing the research.' },
  { value: 'technology_developer', label: 'Technology developer', description: 'Your organisation is in charge of developing the technology.' },
  { value: 'testing_validation', label: 'Testing/validation of approaches and ideas', description: 'Your organisation is in charge of testing/validating the approach and ideas.' },
  { value: 'prototyping', label: 'Prototyping and demonstration', description: 'Your organisation is in charge of developing the prototypes and performing demonstrations.' },
  { value: 'ipr_management', label: 'IPR management incl. technology transfer', description: 'Your organisation is in charge of IPR management including technology transfer at the end of the grant.' },
  { value: 'public_procurer', label: 'Public procurer of results', description: 'Your organisation (public authority, hospital, university, local government, etc.) will be using the results afterwards.' },
  { value: 'private_buyer', label: 'Private buyer of results', description: 'Your organisation (from the private sector) will be using the results afterwards.' },
  { value: 'finance_provider', label: 'Finance provider (public or private)', description: 'Your organisation will be providing the financing for the exploitation during or after the end of the project.' },
  { value: 'education_training', label: 'Education and training', description: 'Your organisation is in charge of educating and training researchers.' },
  { value: 'social_sciences', label: 'Contributions from the social sciences or/and the humanities', description: 'Your organisation is in charge of contributing to the social sciences or/and the humanities dimension.' },
