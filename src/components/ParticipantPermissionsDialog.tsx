...
export function ParticipantPermissionsDialog({
  ...
  return <Dialog open={open} onOpenChange={onOpenChange}>
    <DialogContent className="max-w-2xl">
      <DialogHeader>
        <DialogTitle>Participant information permissions — {label}</DialogTitle>
        <DialogDescription>
          Everyone with proposal access can already view every participant’s information; this dialog controls editing
          only. These rights are separate from budget permissions.
        </DialogDescription>
      </DialogHeader>
      <Input
        value={search}
