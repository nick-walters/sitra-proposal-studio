...
interface Props {
  ...
  /** All personnel budget items to compute the 15% threshold */
  personnelCostByParticipant: Map<string, number>;
}

export function B31EquipmentTable({ equipmentItems, participants, personnelCostByParticipant }: Props) {
  // Only show items where equipment > 15% of that participant's personnel costs
