  ...
  public: {
    Tables: {
      ...
      b12_case_subsections: {
        ...
        Relationships: [
          {
            foreignKeyName: "b12_case_subsections_b12_case_id_fkey"
            columns: ["b12_case_id"]
            isOneToOne: false
            referencedRelation: "b12_cases"
      ...
      b12_cases: {
        ...
        Relationships: [
          {
            foreignKeyName: "b12_cases_case_draft_id_fkey"
          ...
          {
            foreignKeyName: "b12_cases_lead_participant_id_fkey"
          ...
          {
            foreignKeyName: "b12_cases_proposal_id_fkey"
            columns: ["proposal_id"]
            isOneToOne: false
