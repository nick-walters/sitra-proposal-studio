      ...
      {isPlaceholder && (
        <div
          className={
            collapsed || moduleCollapsed
              ? 'hidden'
              // Mirrored source-fed tables are page furniture too: they must
              // sit inside the same 18 cm text column as authored text, not
              // run the full width of the module box.
