...
After the LAST major criterion section above (and before "Overall panel assessment"), include a new top-level section with the heading "# Total score" followed by a blank line and then a single line: "**Total score:** ${totalUnweighted} / ${stageKey === "full" ? 15 : 10}${impactWeighting !== 1 ? ` (weighted: ${totalWeighted} / ${(stageKey === "full" ? 5 + 5 * impactWeighting + 5 : 5 + 5 * impactWeighting).toFixed(1)})` : ""}".
