    ...
    <div className="b31-tables-container space-y-4 [&_p]:!my-0 mt-[20px]">
      ...
      {ganttFigure ? (
        <div>
          ...
          />
          <p className={`${tableStyles} italic mt-1`}>
            <span className="font-bold italic">Figure 3.1.b.</span> Gantt chart, showing WP, task, deliverable <span style={{ display: 'inline-block', width: '1.4em', height: '0.9em', border: '1px solid #16a34a', borderRadius: '9999px', verticalAlign: 'middle', position: 'relative', top: '-0.05em' }} /> &amp; milestone <span style={{ display: 'inline-block', width: '0.9em', height: '0.9em', border: '1px solid #dc2626', borderRadius: '50%', verticalAlign: 'middle', position: 'relative', top: '-0.05em' }} /> timings
          </p>
