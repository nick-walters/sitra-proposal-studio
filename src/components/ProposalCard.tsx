        ...
        <CardContent className="p-2 flex items-center gap-2">
          ...
          <div className="flex-1 min-w-0 flex flex-col sm:flex-row sm:items-center gap-1">
            ...
            <div className="flex items-center gap-1 flex-wrap">
              ...
              {destination && (
                <span className="proposal-badge bg-gray-200 text-gray-600 text-[9px] min-h-[18px] flex items-center justify-center">
          ...
          {/* Dates */}
          <div className="flex flex-col gap-0 flex-shrink-0 text-[9px] text-muted-foreground text-right ml-4 mr-4">
            {proposal.deadline && (
            ...
            <div className="flex items-start gap-2 mb-1">
              ...
              <div>
                ...
                <div className="flex items-center gap-1 flex-wrap mt-1">
                  ...
                  {destination && (
                    <span className="proposal-badge bg-gray-200 text-gray-600 text-[9px] max-w-[90px] whitespace-normal text-center leading-tight min-h-[18px] flex items-center justify-center">
                      {destination.abbreviation}
                    </span>
                  )}
                </div>
