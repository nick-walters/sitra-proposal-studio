      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <img src={sitraLogo} alt="Sitra Proposal Studio" className="h-10 mx-auto mb-4" />
            <h1 className="text-2xl text-foreground" style={{ fontFamily: '"Arial Black", "Arial Bold", Gadget, sans-serif' }}>Sitra Proposal Studio</h1>
