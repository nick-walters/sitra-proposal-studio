...
BEGIN
  ...
  FOR i IN REVERSE array_length(v_delete_order, 1) .. 1 LOOP
    ...
    -- Re-inserting participants fires trg_add_expertise_matrix_column, which
    -- seeds a column per participant. Clear those before writing the snapshot's
    -- own columns back, or the unique constraint fires.
