...
DECLARE
  ...
  v_delete_order text[] := ARRAY[
    ...
    'figure_references','figures','section_footnotes','references','section_content',
    ...
    'part_a_data','participant_ocd_uploads','participant_organisation_roles',
...
BEGIN
  ...
  FOREACH v_tbl IN ARRAY v_delete_order LOOP
    v_scope_key := CASE WHEN v_tbl = 'references' THEN '"references"' ELSE v_tbl END;
    v_predicate := v_scope ->> v_scope_key;
