...
function WPBubble({ wp, onRemove }: { wp: WorkPackage; onRemove?: () => void }) {
  return (
    <span 
      ...
      style={{ backgroundColor: wp.color || '#666', border: `1.5px solid ${wp.color || '#666'}`, color: '#ffffff', fontFamily: "'Times New Roman', Times, serif", fontSize: '11pt', fontWeight: 700, lineHeight: 1, verticalAlign: 'baseline', padding: '0px 5px', position: 'relative', top: '-0.5px' }}
    >
      WP{wp.number}
      {onRemove && (
        <button 
                          ...
                          <SelectValue placeholder="-">
                            {del.lead_participant_id ? (
                              <span
                                ...
                                style={{ backgroundColor: '#000', border: '1.5px solid #000', fontFamily: "'Times New Roman', Times, serif", fontSize: '11pt', fontWeight: 700, fontStyle: 'italic', lineHeight: 1, verticalAlign: 'baseline', padding: '0px 5px', position: 'relative', top: '-0.5px' }}
                              >
